...
For example, if you want to make a Deposit in the protocol, you would need to run the following steps: 
...
If you want to make a OpenPosition in the protocol, you would need to run the following steps: 
