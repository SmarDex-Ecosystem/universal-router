 ...
 */
contract TestForkUniversalRouterUsdnShortValidateOpenPosition is UniversalRouterUsdnShortProtocolBaseFixture {
     ...
     */
    function test_ForkUsdnShortValidateOpenPosition() public {
        ...
        assertEq(asset.balanceOf(address(this)), _assetBalanceBefore - minLongPosition, "asset balance");
