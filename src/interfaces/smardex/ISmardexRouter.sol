...
import { ISmardexSwapCallback } from "./ISmardexSwapCallback.sol";
import { ISmardexMintCallback } from "./ISmardexMintCallback.sol";
import { SmardexLibrary } from "../../libraries/smardex/SmardexLibrary.sol";
...
interface ISmardexRouter is ISmardexSwapCallback, ISmardexMintCallback {
     ...
     */
    function addLiquidity(AddLiquidityParams calldata _params, address _to, uint256 _deadline)
        external
        returns (uint256 amountA_, uint256 amountB_, uint256 liquidity_);
     ...
     * @return liquidity_ The amount of liquidity tokens minted.
     */
    function addLiquidityETH(AddLiquidityETHParams calldata _params, address _to, uint256 _deadline)
        external
        payable
     ...
     */
    function quote(uint256 _amountA, uint256 _fictiveReserveA, uint256 _fictiveReserveB)
        external
        pure
     ...
     */
    function getAmountOut(SmardexLibrary.GetAmountParameters memory _param)
        external
        pure
        returns (
            uint256 amountOut_,
     ...
     * @return newFictiveReserveOut_ fictive reserve of the buying token after the swap
     */
    function getAmountIn(SmardexLibrary.GetAmountParameters memory _param)
        external
        pure
        returns (
            uint256 amountIn_,
